 ...
 * Command line was: qdbusxml2cpp /home/mkiol/dev/Jupii/dbus/org.jupii.xml -a /home/mkiol/dev/Jupii/core/dbus_jupii_adaptor
 *
...
#include "/home/mkiol/dev/Jupii/core/dbus_jupii_adaptor.h"
...
void PlayerAdaptor::add(const QString &url, const QString &name, const QString &author, const QString &description, uint type, const QString &app, const QString &icon, bool once, bool play)
{
    // handle method call org.jupii.Player.add
    QMetaObject::invokeMethod(parent(), "add", Q_ARG(QString, url), Q_ARG(QString, name), Q_ARG(QString, author), Q_ARG(QString, description), Q_ARG(uint, type), Q_ARG(QString, app), Q_ARG(QString, icon), Q_ARG(bool, once), Q_ARG(bool, play));
}
