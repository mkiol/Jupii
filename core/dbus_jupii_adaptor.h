...
public Q_SLOTS: // METHODS
    void add(const QString &url, const QString &name, const QString &author, const QString &description, uint type, const QString &app, const QString &icon, bool once, bool play);
