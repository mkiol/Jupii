...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">搜索片段</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">来自网络的流媒体在UPnP设备上可以用两种模式操控。代理 (默认) 或改寄。 在代理模式，%1传递每个来自流媒体主机的信息包（例如网络收音机服务器）到家用网络中的UPnP设备。此操作对于UPnP 设备很透明，所以它在大多数情况下工作。因为信息包在你的手机/平板通过，%1必须被一直启用以确保流媒体工作。在该寄模式, %1 使用 HTTP 转而命令网络主机位于的 UPnP 设备。现行的的流媒体在UPnP 设备和流媒体服务器之间运动，所以没有要求 %1一直启用。改寄模式的缺陷在于不是所有的 UPnP设备都支持改寄。因此在某些设备中该模式不能恰当地工作。</translation>
    </message>
    <message>
        <source>Proxy</source>
    ...
    <message>
        ...
        <translation type="vanished">改变方向</translation>
    </message>
    <message>
