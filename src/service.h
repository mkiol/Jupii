...
class Service : public QObject,
    ...
    Q_PROPERTY(QString deviceFriendlyName READ getDeviceFriendlyName NOTIFY
                   initedChanged)
    Q_PROPERTY(
        QString deviceIconPath READ getDeviceIconPath NOTIFY initedChanged)
   ...
   protected:
    ...
    virtual UPnPClient::Service *createUpnpService(
