...
#ifdef QT_DEBUG
static constexpr const char* APP_VERSION = "2.13.2 (debug)";
#else
#ifdef HARBOUR
static constexpr const char* APP_VERSION = "2.13.2 (harbour)";
#else
static constexpr const char* APP_VERSION = "2.13.2";
#endif  // HARBOUR
#endif  // QT_DEBUG
#ifdef FLATPAK
