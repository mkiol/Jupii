...
install -Dm0755 build/jupii %{buildroot}%{_bindir}/jupii
install -Dm0644 build/jupii.desktop %{buildroot}%{_datadir}/applications/jupii.desktop
install -Dm0644 build/jupii.metainfo.xml %{buildroot}%{_datadir}/metainfo/jupii.metainfo.xml
install -Dm0644 desktop/icons/16x16/jupii.png %{buildroot}%{_datadir}/icons/hicolor/16x16/apps/jupii.png
install -Dm0644 desktop/icons/32x32/jupii.png %{buildroot}%{_datadir}/icons/hicolor/32x32/apps/jupii.png
install -Dm0644 desktop/icons/48x48/jupii.png %{buildroot}%{_datadir}/icons/hicolor/48x48/apps/jupii.png
install -Dm0644 desktop/icons/64x64/jupii.png %{buildroot}%{_datadir}/icons/hicolor/64x64/apps/jupii.png
install -Dm0644 desktop/icons/96x96/jupii.png %{buildroot}%{_datadir}/icons/hicolor/96x96/apps/jupii.png
install -Dm0644 desktop/icons/128x128/jupii.png %{buildroot}%{_datadir}/icons/hicolor/128x128/apps/jupii.png
install -Dm0644 desktop/icons/172x172/jupii.png %{buildroot}%{_datadir}/icons/hicolor/172x172/apps/jupii.png
install -Dm0644 desktop/icons/256x256/jupii.png %{buildroot}%{_datadir}/icons/hicolor/256x256/apps/jupii.png
install -Dm0644 desktop/icons/512x512/jupii.png %{buildroot}%{_datadir}/icons/hicolor/512x512/apps/jupii.png
install -Dm0644 desktop/jupii.svg %{buildroot}%{_datadir}/icons/hicolor/scalable/apps/jupii.svg
%post
...
%doc README.md
%{_bindir}/jupii
%{_datadir}/applications/jupii.desktop
